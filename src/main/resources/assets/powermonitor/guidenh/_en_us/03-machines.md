...
**Starvation:** a machine that can't drain its recipe's EU/t <Color color="#7FFFFF"><Tooltip label="stutters">Progress freezes (parked at -100 internally); the machine looks idle but still reports its full recipe demand.</Tooltip></Color> --
