...
**Starvation:** a machine that can't drain its recipe's EU/t <Tooltip label="stutters" tooltip="Progress freezes (parked at -100 internally); the machine looks idle but still reports its full recipe demand"/> --
