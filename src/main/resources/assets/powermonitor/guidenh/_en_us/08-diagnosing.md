...
**Are the generators pinned?** (No <Color color="#7FFFFF"><Tooltip label="headroom">Rated capacity minus current burden. Positive headroom absorbs demand steps and relay tolls; zero headroom turns every small loss into a slow battery drain.</Tooltip></Color> left?) At 100% with unmet demand: add generation.
...
**<Color color="#7FFFFF"><Tooltip label="Duty cycle">The fraction of time a pulsing load is actually drawing. A machine at 60% duty averages 60% of its recipe EU/t -- size generation for the average, storage for the peaks.</Tooltip></Color> matters.** Loads that pulse can average under your generation
