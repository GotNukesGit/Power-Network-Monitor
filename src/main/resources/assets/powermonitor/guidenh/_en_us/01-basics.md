...
(the *voltage*), and <Tooltip label="amperage" tooltip="Packets per tick. One whole 32 EU packet arriving each tick is one LV amp -- packets never split"/> is how many packets pass per tick.
