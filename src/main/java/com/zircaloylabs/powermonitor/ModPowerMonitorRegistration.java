...
public class ModPowerMonitorRegistration {
    ...
    private static void registerTier(PowerMonitorTier tier) {
        ...
        // NOTE: this reuses GT's own MACHINE_CASINGS art (confirmed indexing,
        // see class javadoc) as the base layer, which is legitimate and
        // matches GT's own covers visually. The 9 PNGs generated by
        // gen_textures.py (assets/powermonitor/textures/blocks/) are NOT
        // wired in yet -- turning our own PNG into something TextureFactory.of()
        // can layer on top requires an IIconContainer implementation
        // registered through Forge's texture stitch (IconRegister/
        // TextureMap hook), which is standard Forge asset pipeline work,
        // not GT-specific, but wasn't verified against this jar this
        // session. Real next step, not guessed at here.
        ITexture overlay = TextureFactory.of(
